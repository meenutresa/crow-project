...
DATABASES = {
    'default': {
        ...
        'NAME': os.path.join(SITE_PATH,'../data.db'),                      # Or path to database file if using sqlite3.
...
#AUTH_PROFILE_MODULE = 'crow.profile'
...
LOGIN_REDIRECT_URL="http://127.0.0.1:8000/accounts/register"
...
SECRET_KEY = ')i@mq5(@pvktr&ko-b@)5m)(tqca$p*jd^1x(o94znpmzldvs)'
